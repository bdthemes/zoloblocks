...
const Pages = ({ TABS, activeTab, setActiveTab, searchText, setSearchText, pullDemos, setPullDemos, pullNewDemos, setIsOpen }) => {
    return (
        <>
            ...
            <div className="demos-container">
                ...
                <div className="zolo-templates">
                    <h2 className="title">{__('Pages', 'zoloblocks')}</h2>
