...
const Pages = ({ pages, pagesPanel, setPagesPanel, handleImportTemplate }) => {
...
const SinglePageTemplate = ({ template, handleImportTemplate }) => {
    ...
    return (
        <>
            ...
            {pagesPanel && (
                <Pages pages={pages} pagesPanel={pagesPanel} setPagesPanel={setPagesPanel} handleImportTemplate={handleImportTemplate} />
            )}
        </>
    );
};
