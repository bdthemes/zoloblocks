            ...
            {proPanel && (
                <ZoloModal className="zolo-pro-modal" onRequestClose={() => setProPanel(false)}>
                    ...
                    <p className="zolo-pro-modal-desc">
                        {__('Get premium resources at ZoloBlocks and save more time with stunning patterns and templates', 'zoloblocks')}
                    </p>
                        ...
                        {upcoming ? (
                            ...
                            <>
                                {isPro ? (
                                    ...
                                    <ZoloToggleControl checked={value} onChange={onClick} __nextHasNoMarginBottom />
                                )}
                            </>
                        )}
                    </div>
