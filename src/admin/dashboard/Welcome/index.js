                ...
                <VideoSection
                    ...
                    description={
                        <>
                            ...
                            <a href="https://youtu.be/jX4sIXG-9fo?list=PLP0S85GEw7DPpFyon1kxBZ8H1Ei7GK1yX" target='_blank'> Exploring Block </a>
                            Videos here and from the <a href='https://zoloblocks.com/' target='_blank'> Homepage</a>.
                        </>
                    }
                    videoInfo={{
                        id: 'jX4sIXG-9fo',
