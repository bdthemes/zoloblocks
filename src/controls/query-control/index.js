  ...
  return (
    <>
      ...
      <TabDynamicControl
        ...
        include={
          <>
            <BaseControl label={__('Include By', 'zoloblocks')}>
              <Select2
              ...
              zoloAllTaxonomies.map((tax, index) => (
                ...
                >
                  <Select2
                    ...
                    value={
                      postQuery?.postIncludeTaxonomies?.[tax.value]?.options || []
                    }
        ...
        exclude={
          <>
            <BaseControl label={__('Exclude By', 'zoloblocks')}>
              <Select2
                classNamePrefix="zolo-select"
                options={EXCLUDE_BY}
              ...
              zoloAllTaxonomies.map((tax, index) => (
                ...
                >
                  <Select2
                    ...
                    options={PRINT_TAXONOMY(allTermList[tax.value])}
                    value={
                      postQuery?.postExcludeTaxonomies?.[tax.value]?.options || []
                    }
