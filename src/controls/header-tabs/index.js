  ...
  return (
    <div className="zolo-panel-control">
      <ButtonGroup className="zolo-tab-group">
        <Button
          className={`zolo-tab ${selectedTab === 'basic' ? 'active__tab' : ''
            }${selectedTab === 'style' ? 'prev__tab' : ''}`}
        ...
        <Button
          className={`zolo-tab ${selectedTab === 'style' ? 'active__tab' : ''
            }${selectedTab === 'basic' ? 'next__tab' : ''}${selectedTab === 'extra' ? 'sup_prev__tab' : ''
            }`}
        ...
        >
          ...
          <h5 className="zolo-tab-label">
            {__('Style', 'zolo-blocks')}
          </h5>
        </Button>
        <Button
          className={`zolo-tab ${selectedTab === 'extra' ? 'active__tab' : ''
            }${selectedTab === 'style' ? 'next__tab' : ''}`}
      ...
      <div className="zolo-tab-controls">
        {selectedTab === 'basic' && <Fragment>{generalTab}</Fragment>}
        {selectedTab === 'style' && <Fragment>{styleTab}</Fragment>}
