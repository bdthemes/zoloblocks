    ...
    return (
        <>
                ...
                >
                    {generalTab && (
                        <ZoloToggleGroupControlOption
                            className="zolo-header-tab-group-option zolo-basic-tab"
                            value="basic"
                            label={
                                <>
                                    <div className="zolo-tab-button-content">
                    ...
                    {styleTab && (
                        <ZoloToggleGroupControlOption
                            className="zolo-header-tab-group-option zolo-style-tab"
                            value="style"
                            label={
                                <>
                                    <div className="zolo-tab-button-content">
                    ...
                    <ZoloToggleGroupControlOption
                        className="zolo-header-tab-group-option zolo-extra-tab"
                        value="extra"
                        label={
                            <>
                                <div className="zolo-tab-button-content">
            ...
            {zoloParams?.zolo_pro_status === 'inactive' && (
                <ProNotice
                    title={__('Get Zoloblocks Pro for advanced blocks and features.', 'zoloblocks')}
                    btnLabel={__('Go Premium', 'zoloblocks')}
                    btnUrl="https://zoloblocks.com/pricing"
                />
            )}
        </>
    );
