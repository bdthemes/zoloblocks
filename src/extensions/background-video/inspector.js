...
const { ImageAvatar, ZoloButton, ZoloBaseControl} = window.zoloModule;
...
const Inspector = ({ panelProps }) => {
    ...
    return (
        <>
            <ZoloBaseControl label={__('Select Video', 'zoloblocks')} className="zolo-flex-col-control">
                {id ? (
                    <ImageAvatar
            ...
            <ZoloBaseControl label={__('Poster (optional)', 'zoloblocks')} className="zolo-flex-col-control">
                {falbackImageURL ? (
                    <ImageAvatar
