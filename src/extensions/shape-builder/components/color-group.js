                    ...
                    {value?.fillType === 'gradient' && (
                        <>
                            ...
                            <ZoloRangeControl
                                ...
                                onChange={(newValue) => onChange({ ...value, gradientLocation1: newValue })}
                                min={0}
                                max={100}
                                step={1}
                            />
                            ...
                            <ZoloRangeControl
                                ...
                                onChange={(newValue) => onChange({ ...value, gradientLocation2: newValue })}
                                min={0}
                                max={100}
                                step={1}
                            />
                            ...
                            {value?.gradientType === 'linear' && (
                                <ZoloRangeControl
                                    ...
                                    onChange={(newValue) => onChange({ ...value, gradientAngle: newValue })}
                                    min={0}
                                    max={360}
                                    step={1}
                                />
