...
export const MASK_SHAPES = [
    { label: __('None', 'zoloblocks'), value: '', image: '' },
    { label: __('Abstract', 'zoloblocks'), value: 'abstract', image: window.zoloSettings?.maskShapes?.abstract || '' },
    {
        label: __('Abstract Brush 1', 'zoloblocks'),
        value: 'abstract-brush-1',
        image: window.zoloSettings?.maskShapes?.['abstract-brush-1'] || '',
    },
    {
        label: __('Abstract Brush 2', 'zoloblocks'),
        value: 'abstract-brush-2',
        image: window.zoloSettings?.maskShapes?.['abstract-brush-2'] || '',
    },
    {
        label: __('Aesthetic Blob', 'zoloblocks'),
        value: 'aesthetic-blob',
        image: window.zoloSettings?.maskShapes?.['aesthetic-blob'] || '',
    },
    {
        label: __('Amorphous Blob', 'zoloblocks'),
        value: 'amorphous-blob',
        image: window.zoloSettings?.maskShapes?.['amorphous-blob'] || '',
    },
    { label: __('Brush', 'zoloblocks'), value: 'brush', image: window.zoloSettings?.maskShapes?.brush || '' },
    { label: __('Comment', 'zoloblocks'), value: 'comment', image: window.zoloSettings?.maskShapes?.comment || '' },
    { label: __('Container', 'zoloblocks'), value: 'container', image: window.zoloSettings?.maskShapes?.container || '' },
    {
        label: __('Hand Drawn Blob', 'zoloblocks'),
        value: 'hand-drawn-blob',
        image: window.zoloSettings?.maskShapes?.['hand-drawn-blob'] || '',
    },
    { label: __('Hexagon', 'zoloblocks'), value: 'hexagon', image: window.zoloSettings?.maskShapes?.hexagon || '' },
    { label: __('Hexagon Blob', 'zoloblocks'), value: 'hexagon-blob', image: window.zoloSettings?.maskShapes?.['hexagon-blob'] || '' },
    {
        label: __('Irregular Blob', 'zoloblocks'),
        value: 'irregular-blob',
        image: window.zoloSettings?.maskShapes?.['irregular-blob'] || '',
    },
    { label: __('Minimal Round', 'zoloblocks'), value: 'minimal-round', image: window.zoloSettings?.maskShapes?.['minimal-round'] || '' },
    { label: __('Octagon', 'zoloblocks'), value: 'octagon', image: window.zoloSettings?.maskShapes?.octagon || '' },
    { label: __('Organic Blob', 'zoloblocks'), value: 'organic-blob', image: window.zoloSettings?.maskShapes?.['organic-blob'] || '' },
    { label: __('Oval Blob', 'zoloblocks'), value: 'oval-blob', image: window.zoloSettings?.maskShapes?.['oval-blob'] || '' },
    { label: __('Pattern', 'zoloblocks'), value: 'pattern', image: window.zoloSettings?.maskShapes?.pattern || '' },
    { label: __('Popup 1', 'zoloblocks'), value: 'popup-1', image: window.zoloSettings?.maskShapes?.['popup-1'] || '' },
    { label: __('Popup 2', 'zoloblocks'), value: 'popup-2', image: window.zoloSettings?.maskShapes?.['popup-2'] || '' },
    { label: __('Popup 3', 'zoloblocks'), value: 'popup-3', image: window.zoloSettings?.maskShapes?.['popup-3'] || '' },
    { label: __('Round Brush', 'zoloblocks'), value: 'round-brush', image: window.zoloSettings?.maskShapes?.['round-brush'] || '' },
    { label: __('Round Design', 'zoloblocks'), value: 'round-design', image: window.zoloSettings?.maskShapes?.['round-design'] || '' },
    { label: __('Square Pattern', 'zoloblocks'), value: 'squar-pattern', image: window.zoloSettings?.maskShapes?.['squar-pattern'] || '' },
    { label: __('Testimonial', 'zoloblocks'), value: 'testimonial', image: window.zoloSettings?.maskShapes?.testimonial || '' },
    { label: __('Triangle Blob', 'zoloblocks'), value: 'triangle-blob', image: window.zoloSettings?.maskShapes?.['triangle-blob'] || '' },
    { label: __('Custom', 'zoloblocks'), value: 'custom', image: '', pro: true },
];
