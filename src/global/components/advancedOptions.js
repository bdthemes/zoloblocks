  ...
  const panels = (
    <>
      ...
      {globalConfig?.responsiveControls && (
        <>
          <ZoloPanelBody
            title={__("Responsive Control", "zoloblocks")}
            panelProps={props}
            extraPanel={true}
          >
            <ToggleControl
      ...
      <ZoloPanelBody
        title={__("Custom Attributes", "zoloblocks")}
        panelProps={props}
        extraPanel={true}
      >
        <TextControl
