...
import { softMinifyCssStrings, customCssZoloToBlockId } from '../../helpers/helper';
...
export const GlobalStyleHanlder = (props) => {
  ...
  const { uniqueId, zoloStyles, globalConfig, customCss } = attributes;
  ...
  const blockWriteCss = softMinifyCssStrings(
    customCssZoloToBlockId(customCss, uniqueId)
  );
