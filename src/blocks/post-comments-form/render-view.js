...
export default function RenderView({ attributes }) {
    ...
    return (
        <>
            {showCommentTitle && (
                <div className="zolo-comment-count">
                    {showCommentCount && <span>1</span>} {__('Comment', 'zoloblocks')}
                </div>
            )}
            ...
            <ul className="zolo-comment-list">
                <li className="comment byuser comment-author-admin bypostauthor even thread-even depth-1">
                    <div className="comment-body">
                        <footer className="comment-meta">
                            ...
                            <div className="comment-metadata">
                                <a onClick={(event) => event.preventDefault()} href="#">
                                    October 15, 2024 at 10:04 am
                                </a>
                                &nbsp;
                                <a onClick={(event) => event.preventDefault()} className="comment-edit-link" href="#">
                                    Edit
                                </a>
                            </div>
                        </footer>
                        ...
                        <div className="reply">
                            <a onClick={(event) => event.preventDefault()} className="comment-reply-link" href="#">
                                Reply
                            </a>
                        </div>
                    </div>
                ...
                <div id="respond" className="comment-respond">
                    ...
                    <form action="#" method="post" id="commentform" className="zolo-comment-form">
                        ...
                        <div className="zolo-form-group">
                            <textarea id="comment" name="comment" cols="45" rows="6" placeholder={__('Comment', 'zoloblocks')}></textarea>
                        </div>
