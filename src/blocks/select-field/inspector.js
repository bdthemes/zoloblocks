          ...
          <>
            ...
            <ZoloPanelBody title={__('Content', 'zoloblocks')} panelProps={props}>
              ...
              <TextControl
                ...
                help={__('Each name attribute must be unique to submit form data correctly. Leave the field blank if no custom name attribute is necessary.', 'zoloblocks')}
              />
          ...
          <>
            ...
            >
              ...
              <TypographyDropdown
                ...
                requiredProps={requiredProps}
              />
              <BorderControl label={__('Border', 'zoloblocks')} controlName={FIELD_BORDER}
                             requiredProps={requiredProps}/>
              <ResDimensionsControl
                label={__('Border Radius', 'zoloblocks')}
