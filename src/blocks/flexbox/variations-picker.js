...
const VariationPicker = (props) => {
    const { clientId, setAttributes, closeModal, onRemove, isReplace = false } = props;
    ...
    return (
        <div className="zolo-container-variation-picker">
            <BlockVariationPicker
                icon={<LayoutIcon />}
                label={__('Choose Flexbox Layout', 'zoloblocks')}
                instructions={__('Select a Flexbox column layout to start with.', 'zoloblocks')}
