...
export const BUTTON_ONE_MARGIN = 'buttonOneMargin';
...
export const BUTTON_TWO_BORDER_RADIUS = 'buttonTwoBorderRadius';
export const BUTTON_TWO_MARGIN = 'buttonTwoMargin';
...
export const MIDDLE_TEXT_PADDING = 'middleTextPadding';
