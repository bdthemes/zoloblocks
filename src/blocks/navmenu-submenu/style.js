...
export default function Style({ props }) {
    ...
    const desktopAllStyle = `
        ...
        .zolo-block.wp-block-zolo-navmenu .zolo-navmenu-submenu-wrapper .${uniqueId}.wp-block-zolo-navmenu-submenu {
            ${dropdownWrapBGDesk}
        ...
        .zolo-block.wp-block-zolo-navmenu .zolo-navmenu-submenu-wrapper .${uniqueId}.wp-block-zolo-navmenu-submenu .zolo-navmenu-link:hover {
