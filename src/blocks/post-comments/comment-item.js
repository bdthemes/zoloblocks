    ...
    return (
        <div className="zolo-item">
            <div className="zolo-meta">
                {showAuthor && <div className="zolo-avatar" dangerouslySetInnerHTML={{ __html: comment.avatar }}></div>}
                ...
                <div className="zolo-author-info">
                    ...
                    {showDate && <div className="zolo-date">{comment.date}</div>}
                </div>
            </div>
            {showText && <p className="zolo-text">{content}</p>}
        </div>
    );
}
