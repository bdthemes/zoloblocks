...
export default function Edit(props) {
    ...
    useEffect(() => {
        ...
        if (brandCarouselRef.current) {
            zoloSliderInit(brandCarouselRef.current, options);
        }
    }, [
    ...
    // preview image
    if (preview) {
        return <img src={zoloParams.blocksPreview.postCarousel} alt={__('Brand Carousel Preview', 'zoloblocks')} />;
    }
    ...
    const innerBlocksProps = useInnerBlocksProps(
        ...
        },
        {
            ...
            template: [['zolo/brand-child'], ['zolo/brand-child'], ['zolo/brand-child'], ['zolo/brand-child'], ['zolo/brand-child']],
            templateLock: false,
    ...
    return (
        <>
            ...
            <div {...blockProps}>
                ...
                <div className="swiper" ref={brandCarouselRef}>
