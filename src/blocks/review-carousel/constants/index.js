...
// Block Prefix
export const BLOCK_PREFIX = 'reviewCarousel';
...
export const PRESETS = [
    ...
    { label: __('Preset 4 (Pro)', 'zoloblocks'), value: 'style-4', disabled: false },
];
...
export const REVIEW_CAROUSEL_PADDING = 'reviewCarouselPadding';
export const REVIEW_CAROUSEL_MARGIN = 'reviewCarouselMargin';
