...
const Style = ({ props }) => {
    ...
    const desktopAllStyle = `
        ${
            showLabel
                ? `
            .${uniqueId}.wp-block-zolo-time-field .zolo-label-wrapper {
                ${labelMarginDesk}
            }
            .${uniqueId}.wp-block-zolo-time-field .zolo-label {
                ${labelTypoDesk}
                color: ${labelColor};
            }
            .wp-block-zolo-form.style-3 .${uniqueId}.wp-block-zolo-time-field .zolo-label{
                ${labelPaddingDesk}
                ${labelBGStyle}
                ${labelBorderStyles}
                ${labelBRDesktop}
            ...
            ${
                showRequiredSymbol
                    ? `
                .${uniqueId}.wp-block-zolo-time-field .zolo-required {
                    color: ${requiredColor};
                }
            `
                    : ''
        ...
        .${uniqueId}.wp-block-zolo-time-field .zolo-field-input-item input {
        ...
        .${uniqueId}.wp-block-zolo-time-field .zolo-field-input-item input::placeholder {
            ${placeholderColor ? `color: ${placeholderColor};` : ''}
        }

        .${uniqueId}.wp-block-zolo-time-field .zolo-field-input-item .zolo-input-icon svg {
            ${iconSize}
