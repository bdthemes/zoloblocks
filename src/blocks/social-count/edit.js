...
import { GRID_COLUMNS, COLUMNS_GAP } from './constants';

const { classArrayToStr, SidebarOpener, generateResCounterStyle, generateGapStyle, ZoloToolbarButton, ZoloToolbarGroup } =
    window.zoloModule;
...
export default function Edit(props) {
    ...
    // preview image
    if (preview) {
        return <img src={zoloParams.blocksPreview?.socialCount} alt={__('Social Count Preview', 'zoloblocks')} />;
    }
            ...
            <div {...blockProps}>
                ...
                >
                    <button className="zolo-appender-btn" onClick={() => appendBlock()}>
                        ...
                        {__('Add Social Count', 'zoloblocks')}
                    </button>
                </div>
            </div>
        </>
