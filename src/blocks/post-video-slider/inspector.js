  ...
  return (
    <InspectorControls key="controls">
      <HeaderTabs
        ...
        styleTab={
          <>
            <ZoloPanelBody title={__('Main Slider Image', 'zoloblocks')} firstOpen={true} stylePanel={true}
                           panelProps={props}>
              <BorderControl label={__('Border', 'zoloblocks')} controlName={MAIN_IMG_BORDER}
                             requiredProps={requiredProps}/>
              <ResDimensionsControl
              ...
              />
              <div className="zolo-custom-heading">{__('Image Content', 'zoloblocks')}</div>
              <NormalBGControl requiredProps={requiredProps} controlName={IMG_CONTENT_BG} noMainBGImg={true}/>
              <BorderControl label={__('Border', 'zoloblocks')} controlName={IMG_CONTENT_BORDER}
                             requiredProps={requiredProps}/>
              <ResDimensionsControl
                label={__('Border Radius', 'zoloblocks')}
            ...
            <ZoloPanelBody title={__('Thumbs', 'zoloblocks')} stylePanel={true} panelProps={props}>
              ...
              <TabPanelControl
                options={[
                  ...
                  {value: 'active', label: 'Play Button'},
                ]}
                normalComponents={
                  <>
                    <ResRangeControl
                ...
                hoverComponents={
                  <>
                    <ColorControl
                      label={__('Line Color', 'zoloblocks')}
                      color={lineColor}
