...
//main image
export const MAIN_IMG_BORDER = 'mainImgBorder';
export const MAIN_IMG_BORDER_RADIUS = 'mainImgBRadius';
//image content
export const IMG_CONTENT_BG = 'imgContentBg';
export const IMG_CONTENT_BORDER = 'imgContentBorderBorder';
export const IMG_CONTENT_BORDER_RADIUS = 'imgContentBRadius';
export const IMG_CONTENT_PADDING = 'imgContentPadding';
export const IMG_CONTENT_MARGIN = 'imgContentMargin';
...
//thumbs
export const THUMB_HEIGHT = 'thumbHeight';
