...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initPostFilterTab() {
        ...
        const updateActiveTab = (anchor) => {
            document
                .querySelectorAll('.wp-block-zolo-post-grid .zolo-post-filter-taxonomy a')
    ...
    function initPagination() {
        ...
        const getPageLink = (href) =>
            href.includes('admin-ajax.php') ? href.match(/admin-ajax.*/)?.[0] || '' : href.match(/\/page\/\d+\//)?.[0] || '';
