                    ...
                    <>
                        ...
                        <div className="progress-content">
                            <div className="progress-pie-number">
                                {toggleSuffixPrefix && prefix !== '' && <span className="progress-prefix">{escapeHTML(prefix)}</span>}
                                <span className="progress-number">
                                    <CountUp start={0} end={value || 50} delay={0} duration={duration || 3} />
                                </span>
                                {toggleSuffixPrefix && suffix !== '' && <span className="progress-suffix">{escapeHTML(suffix)}</span>}
                            </div>
