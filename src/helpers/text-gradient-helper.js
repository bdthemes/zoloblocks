...
//             type: 'string',
//             default: isBgDefaultGradient === true ? 'gradient' : 'image',
//         },
//         ...bgColorAttr,
...
export const generateTextGradientsStyles = ({
    controlName,
    attributes,
    noOverlay = false,
    noMainBGImg = false,
  ...
  ${
      (BGnoMainBgi === false && backgroundType === 'image' && bgImageURL) || (backgroundType === 'gradient' && gradientColor)
          ? `
          ${
              customGradient
                  ? gradientColor
                  : `background-image: ${backgroundType === 'image' ? `url("${bgImageURL}")` : backgroundType === 'gradient' ? gradientColor : 'none'};`
          }
    `
          : ' '
  }
  ...
  ${
      BGnoMainBgi === false && backgroundType === 'image' && bgImageURL
          ? `
      ${
  ...
  ${backgroundColor && backgroundType === 'image' ? `background-color: ${backgroundColor};` : ' '}
  ...
  ${
    ...
    ${
        (BGnoMainBgi === false && hov_backgroundType === 'image' && hov_bgImageURL) ||
        (hov_backgroundType === 'gradient' && hov_gradientColor)
            ? `
        background-image: ${
            hov_backgroundType === 'image' ? `url("${hov_bgImageURL}")` : hov_backgroundType === 'gradient' ? hov_gradientColor : 'none'
        };
        `
            : ' '
    }
    ...
    ${hov_backgroundColor && hov_backgroundType === 'image' ? `background-color: ${hov_backgroundColor};` : ' '}
  ...
  `;
    ...
    const overlayStylesDesktop = `
      ...
      ${
          BGnoOverlay === false && isBgOverlay
            ...
            z-index: -1 !important;
            ${
                (BGnoOverlayBgi === false && overlayType === 'image' && ovl_bgImageURL) || (overlayType === 'gradient' && overlayGradient)
                    ? `
                background-image: ${
                    overlayType === 'image' ? `url("${ovl_bgImageURL}")` : overlayType === 'gradient' ? overlayGradient : 'none'
                };
              `
                    : ' '
            }

            ${overlayColor && overlayType === 'image' ? `background-color: ${overlayColor};` : ' '}
        ...
        ${
            BGnoOverlayBgi === false && overlayType === 'image' && ovl_bgImageURL
                ? `
            ${
    ...
    ${
        BGnoOverlay === false && isBgOverlay
            ? `
        ${
            (BGnoOverlayBgi === false && hov_overlayType === 'image' && hov_ovl_bgImageURL) ||
            (hov_overlayType === 'gradient' && hov_overlayGradient)
                ? `
          background-image: ${
              hov_overlayType === 'image' ? `url("${hov_ovl_bgImageURL}")` : hov_overlayType === 'gradient' ? hov_overlayGradient : 'none'
          };
          `
                : ' '
        }

        ${hov_overlayColor && hov_overlayType === 'image' ? `background-color: ${hov_overlayColor};` : ' '}
    ...
    ${
        BGnoOverlay === false && BGnoOverlayBgi === false && isBgOverlay && overlayType === 'image' && ovl_bgImageURL
            ? `
        ${
  ...
  ${
      BGnoOverlay === false && BGnoOverlayBgi === false && isBgOverlay && hov_overlayType === 'image' && hov_ovl_bgImageURL
          ? `
      ${
