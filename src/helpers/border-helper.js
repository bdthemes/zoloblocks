...
export const generateBorderStyle = ({ controlName, attributes }) => {
		...
		deskBorderWidth = `
			...
			${
				right && right != undefined
					? `border-right-width:${right}${deskBorderUnit};`
					: ''
			}
			${
				bottom && bottom != undefined
					? `border-bottom-width:${bottom}${deskBorderUnit};`
					: ''
			}
			${
				left && left != undefined
					? `border-left-width:${left}${deskBorderUnit};`
					: ''
			}
		`;
	}
	...
	if (isLinked) {
		tabBorderWidth = `
			${
				tabTop && tabTop != undefined
					? `border-width:${tabTop}${tabBorderUnit};`
					: ''
			}	
		`;
	} else {
		tabBorderWidth = `
			${
				tabTop && tabTop != undefined
					? `border-top-width:${tabTop}${tabBorderUnit};`
					: ''
			}
			${
				tabRight && tabRight != undefined
					? `border-right-width:${tabRight}${tabBorderUnit};`
					: ''
			}
			${
				tabBottom && tabBottom != undefined
					? `border-bottom-width:${tabBottom}${tabBorderUnit};`
					: ''
			}
			${
				tabLeft && tabLeft != undefined
					? `border-left-width:${tabLeft}${tabBorderUnit};`
					: ''
			}
		`;
	}
	...
	if (isLinked) {
		mobBorderWidth = `
			${
				mobTop && mobTop != undefined
					? `border-width:${mobTop}${mobBorderUnit};`
					: ''
			}
		`;
	} else {
		mobBorderWidth = `
			${
				mobTop && mobTop != undefined
					? `border-top-width:${mobTop}${mobBorderUnit};`
					: ''
			}
			${
				mobRight && mobRight != undefined
					? `border-right-width:${mobRight}${mobBorderUnit};`
					: ''
			}
			${
				mobBottom && mobBottom != undefined
					? `border-bottom-width:${mobBottom}${mobBorderUnit};`
					: ''
			}
			${
				mobLeft && mobLeft != undefined
					? `border-left-width:${mobLeft}${mobBorderUnit};`
					: ''
			}
		`;
	}
