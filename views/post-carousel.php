...
$topclass = 'zolo-post-carousel-wrap wp-block-zolo-post-carousel';
...
$swiperOptions = !empty($settings['sliderOptions']) ? json_encode($settings['sliderOptions']) : [];
...
<div class="<?php echo esc_attr($wrapper_class); ?>" data-settings="<?php echo esc_attr($swiperOptions); ?>" <?php if (!empty($wrapperId)) { ?> id="<?php echo $wrapperId; ?>" <?php } ?>>
    <?php
