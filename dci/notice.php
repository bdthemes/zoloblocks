		...
		<div class="dci-notice">
			<div class="dci-notice-wrapper">
				<div class="dci-header">				
					...
					<p class="dci-desc">
						<?php esc_html_e( 'Get notified when there are new updates available for your plugins and themes. In the current version of this message it is clear that you are being sent a confirmation email to confirm your opt-in.', 'zoloblocks' ); ?>
					</p>
				</div>
					...
					<ul>
						<li>
							<div class="dci-permission-item">
								...
								<div class="dci-desc">
									<h3>
										<?php esc_html_e( 'View Basic Profile Info.', 'zoloblocks' ); ?>
									</h3>
									<p>
										<?php esc_html_e( 'Your WordPress user\'s first & last name, and email address.', 'zoloblocks' ); ?>
									</p>
								</div>
							</div>
						</li>
						<li>
							<div class="dci-permission-item">
								...
								<div class="dci-desc">
									<h3>
										<?php esc_html_e( 'View Basic Website Info.', 'zoloblocks' ); ?>
									</h3>
									<p>
										<?php esc_html_e( 'Homepage URL & title, WP & PHP versions, and site language.', 'zoloblocks' ); ?>
									</p>
								</div>
							</div>
						</li>
						<li>
							<div class="dci-permission-item">
								...
								<div class="dci-desc">
									<h3>
										<?php esc_html_e( 'View Basic Plugin Info.', 'zoloblocks' ); ?>
									</h3>
									<p>
										<?php esc_html_e( 'Current Plugin & SDK versions, and if active or uninstalled.', 'zoloblocks' ); ?>
									</p>
								</div>
							</div>
						</li>
