...
const WithResDeviceBtn = ({
  ...
  const onClickHandler = _device => {
    ...
    setDevice(_device);
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.dispatch)(editor_type).__experimentalSetPreviewDeviceType(_device);
...
const GlobalStyleHanlder = props => {
  ...
  `;
  const allStyle = `
		${(0,_helpers_helper__WEBPACK_IMPORTED_MODULE_1__.softMinifyCssStrings)(desktopAllStyle + desktopGlobalStyles)}
		@media all and (max-width: 1024px) {
			${(0,_helpers_helper__WEBPACK_IMPORTED_MODULE_1__.softMinifyCssStrings)(tabAllStyle + tabGlobalStyles)}
		}
		@media all and (max-width: 767px) {
			${(0,_helpers_helper__WEBPACK_IMPORTED_MODULE_1__.softMinifyCssStrings)(mobileAllStyle + mobileGlobalStyles)}
		}
	`;
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const styles = {
      desktop: (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_1__.softMinifyCssStrings)(desktopAllStyle + desktopGlobalStyles),
      tab: (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_1__.softMinifyCssStrings)(tabAllStyle + tabGlobalStyles),
      mobile: (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_1__.softMinifyCssStrings)(mobileAllStyle + mobileGlobalStyles)
    };
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", null, allStyle));
};
