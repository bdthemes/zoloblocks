    ...
    final class Zolo_Block_Enqueue
    {
        ...
        public function block_assets_loader() {
            ...
            if( ! is_admin( ) ) {
                ...
                wp_enqueue_script(
                    'zolo-magnific-popup',
                    ZOLO_ADMIN_URL . 'assets/js/magnific-popup/jquery.magnific-popup.min.js',
                    [ 'jquery' ],
                    ZOLO_VERSION,
                    true
                );
                ...
                wp_enqueue_script(
                    'zolo-magnific-popup-script',
                    ZOLO_ADMIN_URL . 'assets/js/scripts.js',
                    [ 'jquery' ],
                    ZOLO_VERSION,
                    true
                );
