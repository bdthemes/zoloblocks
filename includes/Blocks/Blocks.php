...
return apply_filters('zolo_blocks_list_data', [
    ...
    // =========================================================================
    // PRO BLOCKS — display-only metadata for admin dashboard upgrade teasers.
    // No implementation code for these blocks exists in this plugin.
    // Implementation is provided by the zoloblocks-pro add-on plugin.
    // When the pro add-on is active, it overrides these entries via the
    // 'zolo_blocks_list_data' filter with full implementation details.
    // =========================================================================
    'modal' => [
        'name' => 'modal',
