...
if ( ! class_exists( 'Zolo_Blocks_Loader' ) ) {
	...
	final class Zolo_Blocks_Loader {
		...
		public function loader() {
			...
			require_once ZOLO_DIR_PATH . 'classes/utils.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-install.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-admin-helper.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-block-module.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-helper.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-scripts-utils.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-filesystem.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-update.php';

			// BSF Analytics.
			if ( ! class_exists( 'BSF_Analytics_Loader' ) ) {
				require_once ZOLO_DIR_PATH . 'admin/bsf-analytics/class-bsf-analytics-loader.php';
			}
			...
			$spectra_bsf_analytics->set_entity(
				array(
					'bsf' => array(
						...
						'path'            => ZOLO_DIR_PATH . 'admin/bsf-analytics',
			...
			if ( 'yes' === $enable_templates_button ) {
				require_once ZOLO_DIR_PATH . 'lib/class-uagb-ast-block-templates.php';
			} else {
				add_filter( 'ast_block_templates_disable', '__return_true' );
			}

			if ( is_admin() ) {
				require_once ZOLO_DIR_PATH . 'classes/class-uagb-beta-updates.php';
				require_once ZOLO_DIR_PATH . 'classes/class-uagb-rollback.php';
			}
		...
		public function load_plugin() {
			...
			require_once ZOLO_DIR_PATH . 'blocks-config/blocks-config.php';
			require_once ZOLO_DIR_PATH . 'lib/astra-notices/class-astra-notices.php';

			if ( is_admin() ) {
				require_once ZOLO_DIR_PATH . 'classes/class-uagb-admin.php';
			}

			require_once ZOLO_DIR_PATH . 'classes/class-uagb-post-assets.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-front-assets.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-init-blocks.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-rest-api.php';
			require_once ZOLO_DIR_PATH . 'classes/class-uagb-coming-soon.php';

			if ( 'twentyseventeen' === get_template() ) {
				require_once ZOLO_DIR_PATH . 'classes/class-uagb-twenty-seventeen-compatibility.php';
			}

			require_once ZOLO_DIR_PATH . 'admin-core/admin-loader.php';
...
/**
 *  Prepare if class 'Zolo_Blocks_Loader' exist.
 ...
 */
function uagb() {
	return Zolo_Blocks_Loader::get_instance();
}
