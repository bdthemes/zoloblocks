					...
					<>
						...
						>
							<SelectControl
								...
								options={
									applyFilters(
										'zolo_pricing_table_style_filter',
										STYLES
									) || STYLES
								}
						...
						>
							...
							<SelectControl
								...
								options={TITLE_TAG}
								onChange={(selected) =>
									setAttributes({ titleTagName: selected })
								}
							/>
							<ToggleControl
						...
						>
							<TextControl
								...
								value={pricePrefix}
								onChange={(pricePrefix) =>
									setAttributes({ pricePrefix })
								}
							...
							{sale && (
								<TextControl
									...
									value={orginalPrice}
									onChange={(orginalPrice) =>
										setAttributes({ orginalPrice })
									}
								/>
							)}
							...
							<TextControl
								...
								help={__(
									'Using comma indicator for multiple lines',
									'zolo-blocks'
								)}
							/>
						</PanelBody>
						...
						>
							<ToggleControl
								...
								onChange={(showFeatureHeading) =>
									setAttributes({ showFeatureHeading })
								}
							/>
						...
						>
							...
							<ToggleControl
								...
								onChange={(buttonOpenNewTab) =>
									setAttributes({ buttonOpenNewTab })
								}
							/>
							...
							<ToggleControl
								...
								checked={showChatBtn}
								onChange={(showChatBtn) =>
									setAttributes({ showChatBtn })
								}
							/>
							{showChatBtn && (
								<>
									<TextControl
										label={__('Button Text', 'zolo-blocks')}
										value={chatBtnText}
										onChange={(chatBtnText) =>
											setAttributes({ chatBtnText })
										}
									/>
									<TextControl
										label={__('Link', 'zolo-blocks')}
										value={chatBtnLink}
										onChange={(chatBtnLink) =>
											setAttributes({ chatBtnLink })
										}
										help={__(
											'http://your-link.com',
											'zolo-blocks'
									...
									<ToggleControl
										...
										onChange={(chatBtnOpenNewTab) =>
											setAttributes({ chatBtnOpenNewTab })
										}
									/>
								</>
							)}
							...
							{showRibbon && (
								<>
									<TextControl
										label={__('Title', 'zolo-blocks')}
										value={ribbonTitle}
										onChange={(ribbonTitle) =>
											setAttributes({ ribbonTitle })
										}
									/>
				...
				styleTab={
					<>
						...
						>
							...
							{showDesc && (
								<>
									<Divider />
									<BaseControl>
										<h3 className="zolo-devider-title">
											{' '}
											{__(
												'Description ',
												'zolo-blocks'
						...
						>
							...
							<PanelBody
								title={__('Box Shadow', 'zolo-blocks')}
								initialOpen={false}
							>
								<BoxShadowControl
