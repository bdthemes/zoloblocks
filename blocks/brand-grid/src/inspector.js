 ...
 */
const { NormalBGControl, BorderControl, ResDimensionsControl, TabPanelControl, BoxShadowControl, ResRangeControl } = window.zoloModule;
...
function Inspector(props) {
    ...
    const { uniqueId, preset, heading, resMode, showBrandName, showBrandLink } = attributes;
                ...
                >
                    {(tab) => (
                        <div className={'eb-tab-controls' + tab.name}>
                            {tab.name === 'settings' && (
                                <>
                                    ...
                                    <PanelBody title={__('Content', 'zolo-blocks')} initialOpen={false}>
                                        ...
                                        <br />
                                        <ResAlignmentControl
                                            label={__('Description Alignment', 'zolo-blocks')}
                                            ...
                                            <Fragment>
                                                ...
                                                {preset === 'style-1' && (
                                                    <SelectControl
                                                        ...
                                                        value={presetOneStyles.buttonIconPosition}
                                                    />
                                                )}
                                                {preset === 'style-2' && (
                                                    <SelectControl
                                                        ...
                                                        value={presetTwoStyles.buttonIconPosition}
                                                    />
                                                )}
                                                {preset === 'style-3' && (
                                                    <SelectControl
                                                        ...
                                                        value={presetThreeStyles.buttonIconPosition}
                                                    />
                                                )}
                                                <ResRangeControl
                                                    label={__('Icon Size', 'zolo-blocks')}
                            ...
                            {tab.name === 'design' && (
                                <>
                                    <PanelBody title={__('Icon', 'zolo-blocks')} initialOpen={true}>
                                        <TabPanelControl
                                            normalComponents={
                                                <>
                                                    <ColorControl
                                        ...
                                        <TabPanelControl
                                            ...
                                            hoverComponents={
                                                <>
                                                    <ColorControl
                                                        label={__('Background Hover Color', 'zolo-blocks')}
