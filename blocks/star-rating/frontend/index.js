...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (starRatingItems.length) {
    starRatingItems.forEach(item => {
      ...
      (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.render)((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_src_controls_star_rating__WEBPACK_IMPORTED_MODULE_2__["default"], {
        rating: ratingValue,
        total: 5
      }), item);
    });
