        ...
        <HeaderTabs
          ...
          generalTab={
            <>
              ...
              {showReadMore && (
                <ZoloPanelBody
                  title={__("Read More Button", "zoloblocks")}
                  panelProps={props}
                >
                  <ToggleControl
          ...
          styleTab={
            <>
              <ZoloPanelBody
                title={__("Item Container", "zoloblocks")}
                firstOpen={true}
                stylePanel={true}
                panelProps={props}
              >
