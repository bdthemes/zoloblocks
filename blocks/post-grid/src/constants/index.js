...
export const PRESETS = [
    ...
    { label: __('Style 1', 'zolo-blocks'), value: 'style-2' },
    { label: __('Style 2', 'zolo-blocks'), value: 'style-3' },
    { label: __('Style 3', 'zolo-blocks'), value: 'style-4' },
    { label: __('Style 4', 'zolo-blocks'), value: 'style-5' },
];
