              ...
              <TabPanelControl
                normalComponents={
                  <>
                    ...
                    <BorderControl label={__('Border', 'zoloblocks')} controlName={HOME_BORDER}
                                   requiredProps={requiredProps}/>
                    <ResDimensionsControl
                      label={__('Border Radius', 'zoloblocks')}
              ...
              <TabPanelControl
                normalComponents={
                  <>
                    ...
                    <BorderControl label={__('Border', 'zoloblocks')} controlName={CURRENT_BORDER}
                                   requiredProps={requiredProps}/>
                    <ResDimensionsControl
                      label={__('Border Radius', 'zoloblocks')}
                ...
                hoverComponents={
                  <>
                    ...
                    />
                    <NormalBGControl requiredProps={requiredProps} controlName={CURRENT_HOVER_BG} noMainBGImg={true}/>
                    <ColorControl
                      label={__('Border Color', 'zoloblocks')}
              ...
              <TabPanelControl
                normalComponents={
                  <>
                    ...
                    <BorderControl label={__('Border', 'zoloblocks')} controlName={SEP_BORDER}
                                   requiredProps={requiredProps}/>
                    <ResDimensionsControl
                      label={__('Border Radius', 'zoloblocks')}
