        ...
        <HeaderTabs
            ...
            <>
              ...
              >
                ...
                <ToggleControl
                  ...
                  help={__(
                    "This option will only work at the frontend",
                    "zoloblocks",
                  )}
                />
              ...
              {showLightbox && (
                <ZoloPanelBody
                  title={__("Lightbox Settings", "zoloblocks")}
                  panelProps={props}
                >
                  <ToggleControl
                    ...
                    onChange={() =>
                      setAttributes({ showLightboxThumb: !showLightboxThumb })
                    }
                  />
                  <ToggleControl
                    ...
                    onChange={() =>
                      setAttributes({ showThumbCaption: !showThumbCaption })
                    }
                  />
                  <ZoloIconPicker
                    label={__("Lightbox Opener Icon", "zoloblocks")}
                    value={lightboxIcon}
                    onChange={(value) => {
                      setAttributes({
                        lightboxIcon: value,
          ...
          styleTab={
            <>
              ...
              <ZoloPanelBody
                title={__("Overlay Background", "zoloblocks")}
                stylePanel={true}
                panelProps={props}
              >
                <NormalBGControl
