            ...
            <HeaderTabs
                ...
                styleTab={
                    <>
                        ...
                        <PanelBody
                            title={__('Quote Icon', 'zolo-blocks')}
                            onToggle={(value) => value === true && setAttributes({ selectedPanel: 'quoteIconStyle' })}
                            opened={selectedPanel === 'quoteIconStyle'}
                        >
                            <ColorControl
