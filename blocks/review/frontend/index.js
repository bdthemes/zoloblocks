/******/ (function () {
  ...
  \*******************************************/
			/***/ function (
				...
				const StarRating = (_ref) => {
					let { total = 5, rating } = _ref;
					const fraction =
						Math.round((rating - Math.floor(rating)) * 10) / 10;
  ...
  \***************************************/
		...
		/* harmony import */ var _src_controls_star_rating__WEBPACK_IMPORTED_MODULE_1__ =
			__webpack_require__(
				/*! ../../../src/controls/star-rating */ './src/controls/star-rating/index.js'
			);
		...
		const ReviewFrontend = (_ref) => {
			...
			return (0,
			_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
				_src_controls_star_rating__WEBPACK_IMPORTED_MODULE_1__[
					'default'
				],
				{
					rating: rating,
