(() => {
	...
	const a = window.wp.element,
		e = (e) => {
			let { total: t = 5, rating: l } = e;
			const r = Math.round(10 * (l - Math.floor(l))) / 10,
				L = Math.floor(l),
				n = t - Math.ceil(l);
			let s = [];
			for (let a = 0; a < L; a++) s.push(a);
			let m = [];
			for (let a = 0; a < n; a++) m.push(a);
	...
	(0, a.render)(
		(0, a.createElement)(
			() => (0, a.createElement)(e, { rating: 2, total: 5 }),
			null
		),
