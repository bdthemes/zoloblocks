        ...
        <HeaderTabs
          ...
          styleTab={
            <>
              ...
              {showDesignation && (
                <ZoloPanelBody
                  title={__("Designation", "zoloblocks")}
                  stylePanel={true}
                  panelProps={props}
                >
                  <TypographyDropdown
              ...
              {showSocialProfiles && (
                <>
                  ...
                  <ZoloPanelBody
                    title={__("Social Profiles", "zoloblocks")}
                    stylePanel={true}
                    panelProps={props}
                  >
                    <ResRangeControl
              ...
              {addDetailPageLink && (
                <ZoloPanelBody
                  title={__("Details Page Link", "zoloblocks")}
                  stylePanel={true}
                  panelProps={props}
                >
                  <ResRangeControl
