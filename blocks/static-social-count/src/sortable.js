 ...
 */
const { ZoloIconPicker, SortableControl, SortableItem, LinkControl, TabDynamicControl, ColorControl, TabPanelControl } = window.zoloModule;
                                                    ...
                                                    <TabPanelControl
                                                        normalComponents={
                                                            <>
                                                                ...
                                                                />
                                                                <div className="zolo-custom-heading">{__('Counter', 'zoloblocks')}</div>
                                                                <ColorControl
                                                                    label={__('Color', 'zoloblocks')}
                                                                    color={profile.numberColor}
                                                                    onChange={(value) => {
                                                                        const newItems = [...deepCloneProfiles];
                                                                        newItems[index].numberColor = value;
                                                                        setAttributes({ socialProfiles: newItems });
                                                                    }}
                                                                />
                                                                ...
                                                                <ColorControl
                                                                    label={__('Color', 'zoloblocks')}
                                                                    color={profile.metaSSHColor}
                                                                    onChange={(value) => {
                                                                        const newItems = [...deepCloneProfiles];
                                                                        newItems[index].metaSSHColor = value;
                                                                        setAttributes({ socialProfiles: newItems });
                                                                    }}
                                                                />
                                                            </>
                                                        ...
                                                        hoverComponents={
                                                            <>
                                                                ...
                                                                <ColorControl
                                                                    label={__('Background', 'zoloblocks')}
                                                                    color={profile.bgHoverColor}
                                                                    onChange={(value) => {
                                                                        const newItems = [...deepCloneProfiles];
                                                                        newItems[index].bgHoverColor = value;
                                                                        setAttributes({ socialProfiles: newItems });
                                                                    }}
                                                                />
                                                                ...
                                                                <ColorControl
                                                                    label={__('Color', 'zoloblocks')}
                                                                    color={profile.numberHoverColor}
                                                                    onChange={(value) => {
                                                                        const newItems = [...deepCloneProfiles];
                                                                        newItems[index].numberHoverColor = value;
                                                                        setAttributes({ socialProfiles: newItems });
                                                                    }}
                                                                />
                                                                <div className="zolo-custom-heading">{__('Meta', 'zoloblocks')}</div>
                                                                <ColorControl
                                                                    label={__('Color', 'zoloblocks')}
                                                                    color={profile.metaSSHHoverColor}
                                                                    onChange={(value) => {
                                                                        const newItems = [...deepCloneProfiles];
                                                                        newItems[index].metaSSHHoverColor = value;
                                                                        setAttributes({ socialProfiles: newItems });
                                                                    }}
                                                                />
                                                            </>
