          ...
          generalTab={
            <>
              ...
              >
                ...
                />
                <ToggleControl
                  label={__("Show Button", "zoloblocks")}
                  checked={showButton}
                  onChange={() =>
                    setAttributes({
                ...
                {showButton && (
                  <>
                    <ToggleControl
                      label={__("Show Button Icon", "zoloblocks")}
              ...
              {showButton && showButtonIcon && (
                <ZoloPanelBody
                  title={__("Button Icon", "zoloblocks")}
                  panelProps={props}
                >
                  <ZoloIconPicker
                    label={__("Select Icon", "zoloblocks")}
