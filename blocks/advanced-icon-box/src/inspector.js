        ...
        <InspectorControls key="controls">
            <HeaderTabs
                ...
                styleTab={
                    <>
                        {iconType == 'icon' && (
                            <ZoloPanelBody title={__('Main Icon', 'zolo-blocks')} panelProps={props} stylePanel={true}>
                                <ResRangeControl
                        ...
                        {iconType == 'image' && (
                            <ZoloPanelBody title={__('Image', 'zolo-blocks')} panelProps={props} stylePanel={true}>
                                <>
                                    <ResRangeControl
