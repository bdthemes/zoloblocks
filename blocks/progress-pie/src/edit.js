            ...
            {({ countUpRef }) => (
                ...
                <>
                    ...
                    {/*  optional background if need  */}
                     <circle className="donut-hole progress-donut-hole"  cx="21" cy="21" r="15.91549430918954"    strokeWidth="3" ></circle>
                    ...
                    <circle id="progress1" className="progress-pie-progress"  ref={progress} cx="21" cy="21" r="15.91549430918954" fill="transparent" stroke="url(#gradient)" strokeWidth="3" stroke-dasharray="0 100" stroke-dashoffset="25"></circle>
