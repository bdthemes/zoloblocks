...
export default function Edit(props) {
    ...
    switch (preset) {
        case 'button-1':
            presetStyles = `
				.zolo-advanced-button.${uniqueId}{
					box-shadow: #fff 4px 4px 0 0, ${presetOneStyles && presetOneStyles.shadowColor} 4px 4px 0 1px;
				}
			`;
            break;
        case 'button-2':
        ...
        case 'button-4':
            presetStyles = `
				.zolo-advanced-button.${uniqueId}{
					background: linear-gradient(45deg, transparent 5%, ${presetFourStyles.colorTwo} 5%);
					box-shadow: 6px 0px 0px ${presetFourStyles.colorOne};
				}
				.zolo-advanced-button.${uniqueId}:after{
					background: linear-gradient(45deg, transparent 3%, ${presetFourStyles && presetFourStyles.colorOne} 3%, ${
        ...
        case 'button-10':
            presetStyles = `
				.zolo-advanced-button.${uniqueId}{
					--color: ${presetTenStyles.outlineColor ? presetTenStyles.outlineColor : '#373b44'};
				}`;
            break;
        case 'button-11':
            presetStyles = `
