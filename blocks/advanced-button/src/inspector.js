        ...
        generalTab={
          <>
            <PanelBody
              ...
              onToggle={(value) => value === true && setAttributes({ selectedPanel: 'panel11' })}
              opened={selectedPanel === 'panel11'}
            >
              <SelectControl
            ...
            <PanelBody
              ...
              onToggle={(value) => value === true && setAttributes({ selectedPanel: 'panel12' })}
              opened={selectedPanel === 'panel12'}
            >
              {iconType !== 'iconOnly' && (
                <TextControl
          ...
          <>
            {preset !== '' && (
              <PanelBody
                ...
                onToggle={(value) => value === true && setAttributes({ selectedPanel: 'panel21' })}
                opened={selectedPanel === 'panel21'}
              >
                {preset === 'button-1' && (
                  <Fragment>
                    <ResRangeControl
            ...
            <PanelBody
              ...
              onToggle={(value) => value === true && setAttributes({ selectedPanel: 'panel22' })}
              opened={selectedPanel === 'panel22'}
            >
              <TypographyDropdown
            ...
            {iconType !== 'none' && (
              <PanelBody
                ...
                onToggle={(value) => value === true && setAttributes({ selectedPanel: 'panel23' })}
                opened={selectedPanel === 'panel23'}
              >
                <BorderControl
                  label={__('Border', 'zolo-blocks')}
