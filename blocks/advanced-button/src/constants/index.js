...
export const PRESETS = [
	...
	{ label: __('Preset 4', 'zolo-blocks'), value: 'button-4' },
	{ label: __('Preset 5', 'zolo-blocks'), value: 'button-5' },
	{ label: __('Preset 6', 'zolo-blocks'), value: 'button-6' },
	{ label: __('Preset 7', 'zolo-blocks'), value: 'button-7' },
	{ label: __('Preset 8', 'zolo-blocks'), value: 'button-8' },
	{ label: __('Preset 9', 'zolo-blocks'), value: 'button-9' },
	{ label: __('Preset 10', 'zolo-blocks'), value: 'button-10' },
	{ label: __('Preset 11', 'zolo-blocks'), value: 'button-11' },
	{ label: __('Preset 12', 'zolo-blocks'), value: 'button-12' },
	{ label: __('Preset 13', 'zolo-blocks'), value: 'button-13' },
